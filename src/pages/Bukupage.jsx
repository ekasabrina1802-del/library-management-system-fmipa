...
export default function BukuPage() {
  ...
  const handleEditClick = () => {
    if (selected.length === 1) {
      setModal({
        mode: 'edit',
        book: books.find(b => b.id === selected[0])
      });
    } else {
      alert('Klik satu baris buku dulu untuk diedit.');
    }
  };
    ...
    <div>
      ...
      <div className="grid-3 mb-24">
        <div className="stat-card">
          ...
          <div>
            <div className="stat-value">{books.reduce((s, b) => s + Number(b.stock || 0), 0)}</div>
        ...
        <div className="stat-card">
          ...
          <div>
            <div className="stat-value">{books.reduce((s, b) => s + Number(b.available || 0), 0)}</div>
        ...
        <div className="stat-card">
          ...
          <div>
            <div className="stat-value">{books.reduce((s, b) => s + (Number(b.stock || 0) - Number(b.available || 0)), 0)}</div>
